...
public class BookController {
	...
	{
		return new ResponseEntity<List<Book>>(Arrays.asList(service.getAlBooks()),HttpStatus.OK);
	}
	
	@PutMapping("/update")
	public ResponseEntity<String> updateBook(@RequestBody Book book)
	{
		return new ResponseEntity<String>(service.updateBook(book),HttpStatus.CREATED);
	}
	...
	{
		return new ResponseEntity<Book>(service.getBookById(bookId),HttpStatus.OK);
	}
